...
const (
	...
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 Cats AI 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the Cats AI Deployment and Operation Compliance Commitment"
