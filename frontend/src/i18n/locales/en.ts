export default {
  ...
  admin: {
    ...
    conversationAudit: {
      ...
      description: 'Review API conversation payloads, models, accounts, and request context for security auditing and troubleshooting.',
      secureArea: 'Protected audit area',
      unlockHint: 'Enter the audit secondary password and Google Authenticator code to view conversation records.',
      passwordNotConfigured: 'Set the audit secondary password in System Settings before accessing this page.',
      totpNotEnabled: 'Enable Google Authenticator for this admin account before accessing this page.',
      secondaryPassword: 'Secondary Password',
      totpCode: 'Google Authenticator Code',
      unlock: 'Unlock Audit',
      unlockFailed: 'Failed to unlock conversation audit',
      records: 'Conversation Records',
      accessLogs: 'Access Logs',
      clearAll: 'Clear all records',
      clearConfirm: 'Clear all conversation audit records? This cannot be undone.',
      clearSuccess: 'Cleared {count} conversation records',
      adminAccount: 'Admin Account',
      fingerprint: 'Fingerprint',
      browser: 'Browser',
      result: 'Result',
      failureReason: 'Failure Reason',
      loadFailed: 'Failed to load conversation audit data',
      searchPlaceholder: 'Search request ID or conversation text',
      ...
      endpoint: 'Endpoint',
      requestExcerpt: 'Request Content',
      responseExcerpt: 'Response Content',
      detailTitle: 'Conversation Content',
    ...
    settings: {
      ...
      payment: {
        ...
        field_rate: 'Fixed Rate',
        field_createPath: 'Create Transaction Path',
        field_queryPath: 'Order Query Path',
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe, Airwallex, and USDT/BEpusdt can choose HKD, USD, or another listed currency supported by the account; WeChat Pay, Alipay, and EasyPay remain CNY.',
      ...
      auditSecurity: {
        title: 'Conversation Audit Security',
        description: 'Add an extra lock for sensitive conversation records and configure automatic retention cleanup.',
        requirement: 'Conversation audit access requires admin login, secondary password, and Google Authenticator verification. Each unlock attempt records IP, browser fingerprint, browser, time, and result.',
        secondaryPassword: 'Audit Secondary Password',
        passwordPlaceholder: 'Set a secondary password',
        passwordConfiguredPlaceholder: 'Leave blank to keep the current password',
        passwordHint: 'At least 6 characters. Required before anyone can open Conversation Audit.',
        passwordConfiguredHint: 'A secondary password is configured. Enter a new one only when rotating it.',
        cleanupEnabled: 'Scheduled Cleanup',
        cleanupHint: 'Automatically delete old conversation audit and access records when the audit module is used.',
        retentionDays: 'Retention Days',
        retentionHint: 'Keep records for 1 to 3650 days. Default is 90 days.'
      },
      soraS3: {
        title: 'Sora Storage',
